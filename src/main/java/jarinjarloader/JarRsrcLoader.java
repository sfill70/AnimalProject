...
public class JarRsrcLoader {
    ...
    public static void main(String[] args) throws ClassNotFoundException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, SecurityException, NoSuchMethodException, IOException {
        ...
        Class clazzWithEntryPoint = Class.forName(mi.rsrcMainClass, true, jceClassLoader);

        Class<?> fxEntryPoint = Class.forName("com.sun.javafx.application.LauncherImpl", true, jceClassLoader);
        Method main = fxEntryPoint.getMethod(JIJConstants.MAIN_METHOD_NAME, Class.class, args.getClass());
        main.invoke((Object) null, clazzWithEntryPoint, args);
    }
